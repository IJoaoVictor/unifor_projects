...
final coordinatesProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final querySnapshot = await FirebaseFirestore.instance.collection('coordinates').get();
...
class Gogh extends ConsumerWidget {
  const Gogh({Key? key}) : super(key: key);
                ...
                Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: const AssetImage("lib/images/image6.jpg"),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                    ...
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        actions: [
                          ElevatedButton(
                            onPressed: () async {
                              await FirebaseFirestore.instance.collection('coordinates').add({ // Aqui é feito o envio para o banco de dados
                  ...
                  return Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      onLongPress: () async {
                        ...
                        var collection = FirebaseFirestore.instance.collection('coordinates');
                        var querySnapshots = await collection.get();
                        var documentID = querySnapshots.docs.elementAt(index).id;
                        
                        await FirebaseFirestore.instance.collection('coordinates').doc(documentID).delete();
